...
#-- Comprobar la salida
try:
  if contenido[0] == "Introduce numero: Valor truncado: 1":
      print("> ✅️ TRUNC255(1)=1")
  else:
      print("> ❌️ TRUNC255(1) Incorrecto")  
except IndexError:
    print("> ❌️ NO HAY SALIDA")  

try:
  if contenido[1] == "Introduce numero: Valor truncado: 255":
      print("> ✅️ ABS(300)=255")
  else:
      print("> ❌️ ABS(300) Incorrecto")  
except IndexError:
    print("> ❌️ NO HAY SALIDA")  

try:
  if contenido[2] == "Introduce numero: Valor truncado: 250":
...
try:
  if contenido[3] == "Introduce numero:":
      print("> ✅️ 0")
  else:
      print("> ❌️ No termina con 0")  
except IndexError:
    print("> ❌️ NO HAY SALIDA")  
...
try:
  with open(TEXT, "r") as code_file:
    ...
    print(f"> ❌️ ERROR: No hay código generado")
