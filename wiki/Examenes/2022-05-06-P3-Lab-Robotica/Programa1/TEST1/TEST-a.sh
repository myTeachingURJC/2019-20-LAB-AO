...
#-- Comprobar linea 1: Fib(3)
if [ "$linea1" = "$linea1_OK" ]
then
  echo "> ✅️ Fib(3)=2. OK!"
else
  echo "> ❌️ Fib(3)= $linea1. Debería ser: $linea1_OK"
fi
...
#-- Comprobar linea 3: Fib(6)
if [ "$linea3" = "$linea3_OK" ]
then
  echo "> ✅️ Fib(6)=8. OK!"
else
  echo "> ❌️ Fib(6)= $linea3. Debería ser: $linea3_OK"
fi
...
#-- Comprobar linea 5: Fib(10)
if [ "$linea5" = "$linea5_OK" ]
then
  echo "> ✅️ Fib(10)=55. OK!"
else
  echo "> ❌️ Fib(10)= $linea5. Debería ser: $linea5_OK"
fi
