...
#--
#--  Escritura de un carácter en la pantalla a bajo nivel
#--  a través de la UART, mediante espera activa
#-------------------------------------------------------
...
wait_tx:
	...
	#-- Terminar
	#-- Antes de terminar hay que esperar a que el carácter llegue a la 
	#-- pantalla. Está configurado por defecto un tiempo de 5 ciclos
	#-- Tras esos ciclos se muesta el carácter y terminamos
	#-- Si se termina antes de que transcurran esos ciclos,
	#-- el carácter no aparecerá en la pantalla
	nop
	nop
	nop
	nop
